...
export default function ContactUs() {
  ...
  return (
    <main>
      ...
      <header className="p-8 grid grid-cols-1 md:grid-cols-2 gap-4 pt-10 lg:px-40 bg-blue-50  md:h-96">
      ...
      <section className="">
        <h1
          className={`text-4xl font-bold text-center md:mt-60 my-2 gradient-text text-gray-700 ${
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 mx-2 md:grid-cols-3 gap-3 max-w-6xl md:mx-auto my-10">
          <div className="card p-8 shadow rounded-md flex flex-row items-center space-x-4 hover:cursor-pointer hover:shadow-lg transition duration-200">
            ...
            <p className="text-gray-500 font-light">+254705079016</p>
          </div>
